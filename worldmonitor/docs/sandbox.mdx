...
description: "Exercise the World Monitor API with no key and no quota: deterministic sandbox fixtures, anonymous MCP discovery, and a read-only data surface."
---
